...
export default async function AdminPage() {
  ...
  const CategoriesNames = Categories.data.map((Category) => {
    return { categoryName: Category.categoryName, categoryId: Category._id };
  });
  ...
  return (
    <div className="bg-[#F4F4F5] h-screen flex flex-col p-6 gap-6 w-full">
      ...
      <GetFood
        ...
        CategoriesNamesAndId={CategoriesNames}
      />
    </div>
  );
}
