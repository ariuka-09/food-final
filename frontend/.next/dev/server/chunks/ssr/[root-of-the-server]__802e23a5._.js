...
function LogInPage() {
    ...
    const logIn = async (event)=>{
        ...
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post(`/user/logIn`, {
                email: email,
                password: password
            });
            const { token } = data;
